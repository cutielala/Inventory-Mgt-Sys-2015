        ...
        <form class="form-horizontal " action="#" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?php  foreach ($the_inv->result() as $v) {
echo'<input name="inv_id" type="text" size="50" maxlength="50" id="inv_id" value="'. $v->invoice_id.'xx'.$v->salesorder_id. '" required="required"/>
                     </div>
                    </div>																			
							';}?>
