                                                        ...
                                                        <div class='pull-right'>
                                                            <div class='btn-group'>
                                                                ...
                                                                echo '<a class="btn btn-success" href="#"><i class="fa fa-check"></i>
                                                                    ...
                                                                    echo '<a class="btn btn-warning" href="#" data-toggle="modal" data-target="#UNPAID"><i class="fa fa-cross"></i>
                                                                    UNPAID
                                                                </a>';
                                                                }
                                                                        ?>
                                            ...
                                            <div class='row'>
                                                <div class='col-sm-12'>
                                                    <div class='text-right font-400 font-14'>
                                                        <p>    <h2 class="amount">ex VAT : <i class="fa fa-gbp"></i> <?php echo $info->Grand_total; ?></h2></p><br>
                                                      
                                                    <p>   <h2 class="amount">VAT: <i class="fa fa-gbp"></i> <?php echo $info->VAT_ammount; ?></h2>    </p><br>

                                                        <p>  <h2 class="amount">Total: <i class="fa fa-gbp"></i> <?php echo $info->inc_vat; ?></h2>  </p> <br>
                                                       <br/>
                                                       
                                                       
                                                    </div>
                                                        <!-- Button trigger modal -->
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#mypayment">
  See Payments made
</button>
                                                </div>
                                            </div>
