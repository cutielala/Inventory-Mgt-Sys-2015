...
<!-- DATE RANGE PICKER -->
		...
		<form></form>									
	                                         ...
	                                         <a class="btn btn-danger center" href="<?php echo base_url();?>invoices/index"> See All</a>
													...
													From <input type="date" name="datepickerFrom"  required="required size="8" >
											        To <input type="date" name="datepickerTo"   required="required size="8" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box border pink">
                            <div class="box-title">
                                <h4><i class="fa fa-gbp fa-fw"></i> Invoices List last 60 Days </h4>
