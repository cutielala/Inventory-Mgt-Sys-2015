                                           ...
                                           // echo'<td><strong>' . $in->po_number . '</strong></td>';
                                            ...
                                            if ($in->status === 'invoiced') {
                                                ...
                                                if ($in->sent === 'un-sent') 
                                                    ...
                                                    echo ' <button class="btn btn-xs     btn-dandger  pop-hover" data-title="Not Sent " data-content="invoice raised but not emailed " data-original-title="" title=""><span><i class="fa fa-email"></i></span> <strong>unsent</strong></button></td> ';
                                                    } 
													elseif ($in->sent === 'sent') 
                                                    {
                                                    
                                                    echo ' <button class="btn btn-xs  btn-success"> sent </button></td>';
                                                }
