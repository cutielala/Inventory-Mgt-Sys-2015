                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-header">
                            ...
                            <!-- /BREADCRUMBS -->
                            <div class="clearfix">
                                <h3 class="content-title pull-left"> <?php echo $status[0]?>  invoices</h3>
                            </div>
                            <div class="description">All  <?php echo $status[0]?>  invoices </div>
                        </div>
                    </div>
                </div>
                <!-- /PAGE HEADER -->
												...
												<form action="<?php echo base_url();?>invoices/search" method="post" enctype="multipart/form-data">
										            ...
										            <div class="btn-group">
											            ...
											            To   <input type="date" name="datepickerTo" id="datepickerTo2"  required="required size="8" >
											               <input type="hidden"  readonly="readonly"  name="status" value="<?php echo $status[1]?>"  >
                        ...
                        <div class="box border pink">
                            <div class="box-title">
                                <h4><i class="fa fa-gbp fa-fw"></i> Invoices List :
									...
									echo ' From  <font color="yellow"><strong>'.$date[0].'</strong></font> To <font color="yellow"><strong>'.$date[1].'</strong></font>';}
									?>  
								</h4>
                                ...
                                <table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($invoices->result() as $in) {
											...
											echo'<td><strong>' . substr(sprintf('%05d', $in->salesorder_id),0,5) . '</strong></td>';
												        ...
												        <div class="btn-group dropdown" style="margin-bottom:5px">
											                    <button class="btn btn-primary">Action</button>
											                        ...
											                        <ul class="dropdown-menu">
											                            <li>
											                                <a target="_blank" class="btn btn-danger" href="' . $base_url . 'invoices/view/' . $in->salesorder_id . '">View </a>
											                            </li>
																		<li class="divider"></li>
																		<li>                        
											                                <a target="_blank" class="btn btn-danger"   href="'.  base_url().'invoices/send_inv/'.  $in->invoice_id . '">
																                                                    Email</a>
											                            </li>
