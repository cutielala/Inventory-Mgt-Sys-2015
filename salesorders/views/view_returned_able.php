									                         ...
									                         <?php  $base_url = base_url();
																						...
																						{ 
																						    ...
																						    if(($so->refund)=== 'YES') {
																								...
																								echo'  
											                                                             <a class="btn btn-default pull-left" href="'.  base_url().'salesorders/view_refund/' . $so->salesorder_id .'"><span ><strong>Credit Note  Raised</strong</span></a>
											                                                     ';
																							}
																							  else{
																							...
																							echo'<div class="col-md-8">
											                                                     ...
											                                                     echo'<li>
                                                                                                        ...
                                                                                                        <li>
											                                                                 <a href="'.  base_url().'invoices/so_pdf/'. $so->salesorder_id .'"><span><i class=""></i></span> <strong> Direct Packing Slip </strong></a>
											                                                            </li>
																			                ...
																			                echo' <div class="col-md-2 offset-1 pull-right">
																								        <button class="btn btn-inverse dropdown-toggle"  title="Click to check " data-toggle="dropdown">' . $so->status . '</button>
                                                                                                            ...
                                                                                                            echo'<li> 
																											        <a   href="' . $base_url . 'salesorders/view_invoiced/' . $so->salesorder_id . '"> <strong> View Salesorder Detail </strong> </a>';
											                                                            
                                                                                                            echo'</li>';
																											
																											echo'<li>
																		                                        
											                                                                            <a   href="' . $base_url . 'invoices/view/' . $so->salesorder_id . '"> <strong> View Invoice Detail </strong> </a>
											                                                                    </li>';
