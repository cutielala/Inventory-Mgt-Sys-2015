                    ...
                    <div class="modal-body">
                            <div class="form-group">
                                ...
                                ?>
												...
												<div class="col-md-12"> 
												<table id="datatable_so" cellpadding="0" cellspacing="0" border="0" class="hours-table datatable table table-striped table-bordered table-hover red">';
												        ...
												        <div class="panel-body"> ';
														 ...
														 // echo'<td>';
														  //echo'<div class="text-center">' . $items->ItemPrice . '</div>
															                ...
															                echo '<button type="submit" class="btn btn-danger pull-left  " value="submit" >Change</button>';
															            echo '</form>';
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/uniform/jquery.uniform.min.js"></script>
 <!-- MAGIC SUGGEST -->
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/magic-suggest/magicsuggest-1.3.1-min.js"></script>
  


<script src="http://malsup.github.com/jquery.form.js"></script> 
<!-- SLIDENAV -->
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/slidernav/slidernav.js"></script>
