																   ...
																   {   $this->db->select('SUM(qty) as total_qty');
																	   ...
																	   $bk= $items->item_qty;
															            if ($total_qty >= $bk){
											                                ...
											                                echo '<td><a data-toggle="modal" data-id="' . $items->id . '" data-id2="' . $items->CCL_Item . '"title="Have Available Qty" class="open-AddBookDialog btn btn-info  pop-hover" data-title="Have Available Qty " data-content="' . $total_qty . 'in stock now, not backorder? click to update"" href="#addBookDialog1"><span><i class=""></i></span> <strong>Backorder Update</strong></a>';
