<?php foreach ($query->result() as $table) {
}
?>
...
<script>//showing comap
    function showUser(str)
    {
       ...
       // xmlhttp.open("GET", "<?php echo base_url(); ?>notifications/get_wh_id?q=" + str, true);
	    xmlhttp.open("GET", "<?php echo base_url(); ?>notifications/get_wh_id?q=" + str, true);
        xmlhttp.send();
    }
</script>
                    ...
                    <div class="modal-body">
					 ...
					 <div class="form-group">
		                        ...
		                        <label class="control-label col-md-3">Country:</label>
						             <div class="col-md-12">
										    <p class="form-control-static" data-display="wh_id"></p>
												<div class="form-group">
												    <label class="control-label col-md-3">item</label>
												    <div class="col-md-4">
														  <select name="wh_id" id="country_select" class="col-md-12 full-width-fix" required="required" onchange="showUser(this.value)" >
															 <option value=""></option>
															 <?php 
								foreach ($query->result() as $table) 
								{
                                    ...
                                    echo '<option  value="' . $table->id . 'required="required"">' . $table->CCL_Item . '</option>  ';
                                }
                            ...
                            <div id="txtHint"><b>Business info will be listed here.</b>
                                                    ...
                                                    <div class="scroller" data-height="500px" data-always-visible="1" data-rail-visible="1">
												     ...
												     <div class="list-group">
														  ...
														  <?php  foreach ($orders->result() as $order) {
															    ...
															    echo'';
																echo'
																<p>PO#:'.$order->po_number.'</p>
																<p><i class="fa fa-circle text-green"></i> Status: '.$order->status.'</p>
																<p><h4>Bill Info </h4></p>
                                                                <h6><p><p>Buyer Name: '.$order->Company_name.'</p>
																<p>
												  ...
												  <!---
                                                    ...
                                                    <div class="pull-right hidden-xs">
														...
														<?php  $base_url = base_url();
                                                            ...
                                                            foreach ($salesorders->result() as $so) {
											                        ...
											                        {
                                                                     echo' <div class="col-md-6"> <button class="btn btn-default" href="#box-config" data-toggle="modal" >
																	...
																	echo'<form >
																		...
																		echo'<div class="col-md-6">
																		     <form action="' . base_url() . 'salesorders/pick_all" method="POST">
																         
                                                                        <input type="hidden" name="sales_id" value="' . $so->salesorder_id . '"/>
																		<button type="submit" class="btn btn-pink">Pick All</button>
                                                                                                                       </form></div>'; 
                                                                    } 
                                                    ...
                                                    <table class='table table-hover'>
                                                        ...
                                                        <tbody>
														  ...
														  if (($items->qty>0) &&($items->backorderitem==='NO'))
																   {
                                                                   echo '<td>  ';
														   $i++; 
															  { 
                                                            ...
                                                            /*
																...
																//else 
																   ...
																   {     
                                                                             ...
                                                                             echo '<td><button class="btn btn-inverse  pop-hover" data-title="Available Qty " data-content="' . $items->qty . ' ""><i class="fa fa-check"></i>Stocks Ok</button></td>';
																   ...
																   {   $this->db->select('SUM(qty) as total_qty');
																	   ...
																	   $bk= $items->item_qty;
															            if ($total_qty >= $bk){
																			...
																			echo ' <form><a href="' . $base_url . 'salesorders/update_bkorder/' . $items->id . '"><button class="btn btn-info  pop-hover" data-title="Have Available Qty " data-content="' . $total_qty . 'in stock now, not backorder? click to update"">Update Backorder</button></a>
											 </form></td>';*/
											                                echo '<td><a data-toggle="modal" data-id="' . $items->id . '" data-id2="' . $items->CCL_Item . '"title="Have Available Qty" class="open-AddBookDialog btn btn-info  pop-hover" data-title="Have Available Qty " data-content="' . $total_qty . 'in stock now, not backorder? click to update"" href="#addBookDialog1"><span><i class=""></i></span> <strong>Update/still test dont click</strong></a>';
...
echo form_hidden('total', $incship);
