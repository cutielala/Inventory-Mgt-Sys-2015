...
echo Modules::run('template/menu'); 			?>
<!-- PAGE -->
<section id="page">
                        ...
                        <div class="col-md-12">
												    ...
												    <div class="">
												     ...
												     <div class="list-group">
														  <div class="col-md-6 list-group-item profile-details">
														    ...
														    echo' <input type="hidden" name="path"   value="view_invoiced"/>
                                                            ...
                                                            <table >
				                                                ...
				                                                <tr><td >Shipping Postcode:			</td>
																    <td >	
				                                                 <input type="text" name="ship_Postcode"   value="'.$so->ship_Postcode.'"/>
                  			                                    
                                                                <tr><td >Email:			</td>
																    <td >		
				                                                 <input type="text" name="Shipping_Email" size="40" value="'.$so->Shipping_Email.'"/>                  			                                  </td>
																</td></tr>
														  ...
														  <?php  
																...
																echo  $so->vat_exempt.'<p><h4>Bill Info</h4></p>';
														   ...
														   <div class="col-md-6  col-md-offset-3"><br/>
											                    <button type="submit" class="hidden btn btn-info input-block-level pull-right">Save Change</button>
											                </div>	
													</div> 
													<?php   echo form_close(); ?>
												    </div>
                            ...
                            <div class="box border blue">
								...
								<div class="box-body">
                                    ...
                                    <div class="col-md-6 pull-right box-container">          
									<?php  $base_url = base_url();
										...
										if ($so->status === 'invoiced') {
											...
											if ((isset($so->so_item_note)&&$so->so_item_note=== 'return')) {  
												...
												echo'  
											         <a class="btn btn-info pull-left" href="'.  base_url().'salesorders/view_refund/' . $so->salesorder_id .'"><span ><strong>Credit Note  Raised</strong</span></a>
											    ';	}
												...
												echo'<div class="btn-group dropdown pull-left">
											            <button class="btn btn-default  pop-hover  dropdown-toggle" data-toggle="dropdown"  data-content="Return" >
											                Return<span class="caret"></span></button>
												    ...
												    <div class="col-md-10 pull-right">
															...
															<div class="btn-group dropdown">
											                    <button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
											                        ...
											                        <ul class="dropdown-menu context">
											                           ...
											                           <?php   echo'<form id="packing"  action="' . base_url() . 'index.php/salesorders/packing_slip" method="post">
                                                                                    <input type="hidden" name="sales_id" value="' . $so->salesorder_id . '"/>
                                                                                    <input class="hidden btn btn-default btn-block"    type="submit"   value="Crown Packing Slip "/>
                                                                                </form>
													                   
                                                                                                      
                                                                                             
                                                                       
											                            <a  class="hidden " href="'.base_url().'index.php/invoices/so_pdf/'.$so->salesorder_id.'> Direct Packing Slip </a>
																		 
											                          
																				<li class="divider"></li>                       
                                                                        <li>
										                                        				 
																				<a href='.base_url().'index.php/salesorders/invoice_pdf/'.$payment->invoice_id.'>Invoice Document</a>';?>
											                            </li>
														...
														<?php echo '<button class="btn btn-inverse dropdown-toggle"  title="Click to check payment status" data-toggle="dropdown">' . $so->status . '</button>
																		<ul class="dropdown-menu context">';
                                                                       ...
                                                                       echo'<li>';
                                                                            if($payment->status === 'paid' ){
                                                                                echo '<a class="btn btn-success" href="#"><i class="fa fa-check"></i>
                                                                                    ...
                                                                                    if($pmt->total>0){
																			            ...
																			            if ($paid<$payment->inc_vat){
																		                    ...
																		                    echo '<a class="btn btn-success" href="#"><i class="fa fa-check"></i>  Paid </a>';
																					}
                                                                    		 
																																	 
																				}
                                                                            else{
                                                                                echo'<a class="btn btn-warning "" data-title="UNPAID " data-content="Click to Make Payment" data-original-title="" title=""="#" data-toggle="modal" data-target="#UNPAID">
																				...
																				echo'<li class="divider"></li>
																		                <li>
											                                                                            <a class="btn btn-danger"  href="' . $base_url . 'index.php/invoices/view/' . $so->salesorder_id . '">View Invoice Detail</a>
											                                                                    </li>';
													...
													<?php						      	
                                                        ...
                                                        else if ($so->status === 'returned') {
                                                                                            
															echo'
											                    <a target="_blank" class="btn btn-info pull-right" href="' . $base_url . 'index.php/salesorders/view_returned/' . $so->salesorder_id . '">View Return Detail</a>
                                                                                                               ';
														}																								
...
<!---invoice---end--->
 <!-- SAMPLE BOX CONFIGURATION MODAL FORM-->
    <div class="modal fade " id="UNPAID" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="overflow:hidden;">
        <div class="col-md-10 col-md-offset-1">
		<div class="modal-dialog">
            <div class="modal-content">
        ...
        echo '<input type="hidden"  required="required" name="invoiceid" readonly="readonly" value="'.$payment->invoice_id.'"/>';
             ...
             <option>MONEY BOOKERS</option>
						...
						<br/>
                        <h5>Amount</h5>
		                <input type="text" class="col-md-6" name="amount"  required="required" id="amount_paid" placeholder="Balance: <?php echo $price_with_vat-$paid;?>" maxvalue="<?php echo $price_with_vat-$paid;?>" value=""/><br>
                     	<h5>Currency</strong></h5>
             ...
             <option value="EUR">EUR</option>
		                ...
		                <h5>Paid Date</h5>
                        <input type="text" name="date" id="datepickerPay"required="required" value="" class="form-control"/>
