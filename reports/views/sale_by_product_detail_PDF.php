...
<th style="padding-right:20px; text-align:center; vertical-align:middle;">SALES COST</th> 
                ...
                <tbody> 
                    ...
                    <?php $invoice= $this->db->get($invoice_info)->group_by('CCL_Item');
                    foreach ($invoice->result() as $table) {
                        echo $table->CCL_Item."<tr>
				...
				if (!$table->GBP_Px==='')
				{
				$cost=$table->GBP_Px*$table->item_qty;
				}
				else
				{
					$cost='no cost info';
				...
				echo "<td style=\"width: 80px; text-align:right; padding-right:10px; vertical-align:middle;\">$cost</td>
